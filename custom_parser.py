...
@dataclass
class MyAngularParserOptions(ParserOptions):
...
class MyAngularCommitParser(CommitParser[ParseResult, MyAngularParserOptions]):
    """
    ...
    parser_options = MyAngularParserOptions

    def __init__(self, options: MyAngularParserOptions | None = None) -> None:
    ...
    @staticmethod
    def get_default_options() -> MyAngularParserOptions:
        return MyAngularParserOptions()
